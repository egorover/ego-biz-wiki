            ...
            [
                (
                    ...
                    (
                        ...
                        "Если контекст содержит прямой ответ на вопрос, обязательно "
                        "ответь на него на основе контекста. "
                        "Используй fallback только тогда, когда контекст действительно "
                        "не содержит достаточно информации для достоверного ответа. "
                        "В этом случае верни строго этот текст без кавычек: "
